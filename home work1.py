...
def total_salary(path):
  """
  Функція аналізує текстовий файл з даними про заробітні плати
  розробників та повертає загальну та середню суму заробітної плати.

  Args:
    path: Шлях до текстового файлу.

  Returns:
    Кортеж із двох чисел: загальна сума зарплат і середня заробітна плата.
  """
